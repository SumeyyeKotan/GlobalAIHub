...
class MetroAgi:
    ...
    def istasyon_ekle(self, idx: str, ad: str, hat: str) -> None:
        if idx not in self.istasyonlar:  # Düzeltme: id yerine idx kullanılmalı
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        hedef = self.istasyonlar[hedef_id]
        ziyaret_edildi = set()
        pq = [(0, id(baslangic), baslangic, [baslangic], 0)]  # (toplam_sure, id, istasyon, yol, mevcut_sure)

        while pq:
            toplam_sure, _, istasyon, yol, mevcut_sure = heapq.heappop(pq)
